...
| Funktion | Umsetzung |
|---|---|
| 3D-Arbeitsraum | Kamerasteuerung, Hotspots, gebackenes Abendlicht, Bloom, Ruhemodus und adaptive Bewegungsauflösung |
...
Die [Blender-zu-Three.js-Pipeline für die Raumverfeinerung](docs/room-refinement-workflow.md)
beschreibt Geometrieexport, Lichtatlas, AgX-Look und lokale Vergleichsansichten.
...
|---|---|
| 3D workspace | Camera controls, hotspots, baked evening lighting, bloom, idle rendering, and adaptive motion resolution |
...
The [Blender-to-Three.js room workflow](docs/room-refinement-workflow.md) documents
geometry export, the matching light atlas, the AgX look, and local comparisons.
